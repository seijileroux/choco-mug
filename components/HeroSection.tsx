    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div className="max-w-xl">
        <h1 className="text-5xl md:text-6xl font-black leading-tight mb-6">
          Откройте мир
          <br />
          <span className="text-white/90">изысканного вкуса</span>
          <br />в каждой чашке!
        </h1>
        <p className="text-gray-400 text-lg mb-10 leading-relaxed">
          Для нас кофе — это не просто напиток, а настоящее творчество.
          Отправляйтесь с нами в гастрономическое приключение, где каждый глоток
          — это откровение и наслаждение безупречным вкусом.
        </p>
